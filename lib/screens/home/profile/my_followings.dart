...
import 'package:tiktokClone/screens/home/profile/followings_child.dart';
//import 'search_tile.dart';

class MyFollowings extends StatefulWidget {
  final String userUID;
  MyFollowings({this.userUID});
  @override
  _MyFollowingsState createState() => _MyFollowingsState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: DatabaseService(uid: widget.userUID).getUserFollowings(),
                    ...
                    itemBuilder: (context, index) {
                      return FutureBuilder(
                          future: databaseService
                              .queryUserFollowings(list[index]['followerUid']),
